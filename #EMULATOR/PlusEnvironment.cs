...
namespace Plus
{
    public static class PlusEnvironment
    {
        ...
        public static void Initialize()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("                  _          _     _           _____ __  __ _   _ ");
            Console.WriteLine(@"                 | |   _   _| |__ | |__   __ _| ____|  \/  | | | |");
            Console.WriteLine(@"                 | |  | | | | '_ \| '_ \ / _` |  _| | |\/| | | | |");
            Console.WriteLine("                 | |__| |_| | |_) | |_) | (_| | |___| |  | | |_| |");
            Console.WriteLine(@"                 |_____\__,_|_.__/|_.__/ \__,_|_____|_|  |_|\___/ ");

            Console.ForegroundColor = ConsoleColor.Green;

            Console.WriteLine("                                " + PrettyVersion + " <Build " + PrettyBuild + ">");
            Console.WriteLine("                                LubbaHotel.tk by SwissRetroIndusrty");

            Console.WriteLine("");
            Console.Title = "Loading Lubba Emulator";
            ...
            {
                log.Error("Failed to initialize LubbaEmulator: " + e.Message);
                log.Error("Press any key to shut down ...");
                Console.ReadKey(true);
                Environment.Exit(1);
                return;
        ...
        public static void PerformShutDown()
        {
            ...
            Console.Title = "LUBBA EMULATOR: SHUTTING DOWN!";
            ...
            log.Info("Lubba Emulator has successfully shutdown.");
