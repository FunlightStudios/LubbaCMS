...
namespace Plus.HabboHotel.Rooms.Chat.Commands.User
{
    class InfoCommand : IChatCommand
    {
        ...
        public void Execute(GameClient Session, Room Room, string[] Params)
        {
            ...
            Session.SendPacket(new RoomNotificationComposer("Powered by Lubba Emulator (PlusEdit)",
                 "<b>Credits</b>:\n" +
                 "Lubba Hotel - LubbaEMU\n" +
                 "Sledmore - PlusEMU Founder\n" +
                 "DevBest Community - PlusEMU Edit\n\n" +
