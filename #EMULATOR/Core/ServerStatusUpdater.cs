...
namespace Plus.Core
{
    public class ServerStatusUpdater : IDisposable
    {
        ...
        public void Init()
        {
            ...
            Console.Title = "Lubba Emulator - 0 users online - 0 rooms loaded - 0 day(s) 0 hour(s) uptime";
        ...
        private void UpdateOnlineUsers()
        {
            ...
            Console.Title = "Lubba Emulator - " + UsersOnline + " users online - " + RoomCount + " rooms loaded - " + Uptime.Days + " day(s) " + Uptime.Hours + " hour(s) uptime";
